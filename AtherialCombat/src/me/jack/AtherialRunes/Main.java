...
public class Main extends JavaPlugin {
	...
	//Sets player HealthScale to 40 hearts! And gives starters gear when joining for first time.
	@EventHandler
		...
		Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(this, new Runnable() {
			public void run() {
				if (!(event.getPlayer().hasPlayedBefore())) {
					...
					swordLore1.add(ChatColor.RED + "   ☼DAMAGE: " + ChatColor.WHITE + ChatColor.BOLD.toString() + "+16");
